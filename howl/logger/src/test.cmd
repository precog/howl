...
set java_opts=%java_opts% -Dxa.workers=1800
set java_opts=%java_opts% -Dhowl.log.maxWaitngThreads=500
...
set java_opts=%java_opts% -Dhowl.log.bufferSize=8
...
%java_home%\bin\javac -source %mode% -target %mode% -d ../classes org/objectweb/howl/test/LogTest.java
